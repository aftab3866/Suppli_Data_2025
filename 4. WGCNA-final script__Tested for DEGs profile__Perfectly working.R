...
power <- c(c(1:10), seq(from = 10, to = 30, by = 2))
...
# Transform adjacency matrix into topological overlap matrix (TOM)
TOM = TOMsimilarity(adjacency)

# Hierarchical clustering of genes using TOM
...
dynamicColors = cutreeDynamic(dendro = geneTree, distM = 1-TOM,
...
# 1. Plot the dendrogram with merged module colors
